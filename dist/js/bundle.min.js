...
return this},abort:function(statusText){var finalText=statusText||strAbort;return transport&&transport.abort(finalText),done(0,finalText),this}};if(deferred.promise(jqXHR).complete=completeDeferred.add,jqXHR.success=jqXHR.done,jqXHR.error=jqXHR.fail,s.url=((url||s.url||ajaxLocation)+"").replace(rhash,"").replace(rprotocol,ajaxLocParts[1]+"//"),s.type=options.method||options.type||s.method||s.type,s.dataTypes=jQuery.trim(s.dataType||"*").toLowerCase().match(rnotwhite)||[""],null==s.crossDomain&&(parts=rurl.exec(s.url.toLowerCase()),s.crossDomain=!(!parts||parts[1]===ajaxLocParts[1]&&parts[2]===ajaxLocParts[2]&&(parts[3]||("http:"===parts[1]?"80":"443"))===(ajaxLocParts[3]||("http:"===ajaxLocParts[1]?"80":"443")))),s.data&&s.processData&&"string"!=typeof s.data&&(s.data=jQuery.param(s.data,s.traditional)),inspectPrefiltersOrTransports(prefilters,s,options,jqXHR),2===state)return jqXHR;fireGlobals=jQuery.event&&s.global,fireGlobals&&0===jQuery.active++&&jQuery.event.trigger("ajaxStart"),s.type=s.type.toUpperCase(),s.hasContent=!rnoContent.test(s.type),cacheURL=s.url,s.hasContent||(s.data&&(cacheURL=s.url+=(rquery.test(cacheURL)?"&":"?")+s.data,delete s.data),s.cache===!1&&(s.url=rts.test(cacheURL)?cacheURL.replace(rts,"$1_="+nonce++):cacheURL+(rquery.test(cacheURL)?"&":"?")+"_="+nonce++)),s.ifModified&&(jQuery.lastModified[cacheURL]&&jqXHR.setRequestHeader("If-Modified-Since",jQuery.lastModified[cacheURL]),jQuery.etag[cacheURL]&&jqXHR.setRequestHeader("If-None-Match",jQuery.etag[cacheURL])),(s.data&&s.hasContent&&s.contentType!==!1||options.contentType)&&jqXHR.setRequestHeader("Content-Type",s.contentType),jqXHR.setRequestHeader("Accept",s.dataTypes[0]&&s.accepts[s.dataTypes[0]]?s.accepts[s.dataTypes[0]]+("*"!==s.dataTypes[0]?", "+allTypes+"; q=0.01":""):s.accepts["*"]);for(i in s.headers)jqXHR.setRequestHeader(i,s.headers[i]);if(s.beforeSend&&(s.beforeSend.call(callbackContext,jqXHR,s)===!1||2===state))return jqXHR.abort();strAbort="abort";for(i in{success:1,error:1,complete:1})jqXHR[i](s[i]);if(transport=inspectPrefiltersOrTransports(transports,s,options,jqXHR)){jqXHR.readyState=1,fireGlobals&&globalEventContext.trigger("ajaxSend",[jqXHR,s]),s.async&&s.timeout>0&&(timeoutTimer=setTimeout(function(){jqXHR.abort("timeout")},s.timeout));try{state=1,transport.send(requestHeaders,done)}catch(e){if(!(2>state))throw e;done(-1,e)}}else done(-1,"No Transport");return jqXHR},getJSON:function(url,data,callback){return jQuery.get(url,data,callback,"json")},getScript:function(url,callback){return jQuery.get(url,void 0,callback,"script")}}),jQuery.each(["get","post"],function(i,method){jQuery[method]=function(url,data,callback,type){return jQuery.isFunction(data)&&(type=type||callback,callback=data,data=void 0),jQuery.ajax({url:url,type:method,dataType:type,data:data,success:callback})}}),jQuery._evalUrl=function(url){return jQuery.ajax({url:url,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0})},jQuery.fn.extend({wrapAll:function(html){if(jQuery.isFunction(html))return this.each(function(i){jQuery(this).wrapAll(html.call(this,i))});if(this[0]){var wrap=jQuery(html,this[0].ownerDocument).eq(0).clone(!0);this[0].parentNode&&wrap.insertBefore(this[0]),wrap.map(function(){for(var elem=this;elem.firstChild&&1===elem.firstChild.nodeType;)elem=elem.firstChild;return elem}).append(this)}return this},wrapInner:function(html){return this.each(jQuery.isFunction(html)?function(i){jQuery(this).wrapInner(html.call(this,i))}:function(){var self=jQuery(this),contents=self.contents();contents.length?contents.wrapAll(html):self.append(html)})},wrap:function(html){var isFunction=jQuery.isFunction(html);return this.each(function(i){jQuery(this).wrapAll(isFunction?html.call(this,i):html)})},unwrap:function(){return this.parent().each(function(){jQuery.nodeName(this,"body")||jQuery(this).replaceWith(this.childNodes)}).end()}}),jQuery.expr.filters.hidden=function(elem){return elem.offsetWidth<=0&&elem.offsetHeight<=0||!support.reliableHiddenOffsets()&&"none"===(elem.style&&elem.style.display||jQuery.css(elem,"display"))},jQuery.expr.filters.visible=function(elem){return!jQuery.expr.filters.hidden(elem)};var r20=/%20/g,rbracket=/\[\]$/,rCRLF=/\r?\n/g,rsubmitterTypes=/^(?:submit|button|image|reset|file)$/i,rsubmittable=/^(?:input|select|textarea|keygen)/i;jQuery.param=function(a,traditional){var prefix,s=[],add=function(key,value){value=jQuery.isFunction(value)?value():null==value?"":value,s[s.length]=encodeURIComponent(key)+"="+encodeURIComponent(value)};if(void 0===traditional&&(traditional=jQuery.ajaxSettings&&jQuery.ajaxSettings.traditional),jQuery.isArray(a)||a.jquery&&!jQuery.isPlainObject(a))jQuery.each(a,function(){add(this.name,this.value)});else for(prefix in a)buildParams(prefix,a[prefix],traditional,add);return s.join("&").replace(r20,"+")},jQuery.fn.extend({serialize:function(){return jQuery.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var elements=jQuery.prop(this,"elements");return elements?jQuery.makeArray(elements):this}).filter(function(){var type=this.type;return this.name&&!jQuery(this).is(":disabled")&&rsubmittable.test(this.nodeName)&&!rsubmitterTypes.test(type)&&(this.checked||!rcheckableType.test(type))}).map(function(i,elem){var val=jQuery(this).val();return null==val?null:jQuery.isArray(val)?jQuery.map(val,function(val){return{name:elem.name,value:val.replace(rCRLF,"\r\n")}}):{name:elem.name,value:val.replace(rCRLF,"\r\n")}}).get()}}),jQuery.ajaxSettings.xhr=void 0!==window.ActiveXObject?function(){return!this.isLocal&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&createStandardXHR()||createActiveXHR()}:createStandardXHR;var xhrId=0,xhrCallbacks={},xhrSupported=jQuery.ajaxSettings.xhr();window.attachEvent&&window.attachEvent("onunload",function(){for(var key in xhrCallbacks)xhrCallbacks[key](void 0,!0)}),support.cors=!!xhrSupported&&"withCredentials"in xhrSupported,xhrSupported=support.ajax=!!xhrSupported,xhrSupported&&jQuery.ajaxTransport(function(options){if(!options.crossDomain||support.cors){var callback;return{send:function(headers,complete){var i,xhr=options.xhr(),id=++xhrId;if(xhr.open(options.type,options.url,options.async,options.username,options.password),options.xhrFields)for(i in options.xhrFields)xhr[i]=options.xhrFields[i];options.mimeType&&xhr.overrideMimeType&&xhr.overrideMimeType(options.mimeType),options.crossDomain||headers["X-Requested-With"]||(headers["X-Requested-With"]="XMLHttpRequest");for(i in headers)void 0!==headers[i]&&xhr.setRequestHeader(i,headers[i]+"");xhr.send(options.hasContent&&options.data||null),callback=function(_,isAbort){var status,statusText,responses;if(callback&&(isAbort||4===xhr.readyState))if(delete xhrCallbacks[id],callback=void 0,xhr.onreadystatechange=jQuery.noop,isAbort)4!==xhr.readyState&&xhr.abort();else{responses={},status=xhr.status,"string"==typeof xhr.responseText&&(responses.text=xhr.responseText);try{statusText=xhr.statusText}catch(e){statusText=""}status||!options.isLocal||options.crossDomain?1223===status&&(status=204):status=responses.text?200:404}responses&&complete(status,statusText,responses,xhr.getAllResponseHeaders())},options.async?4===xhr.readyState?setTimeout(callback):xhr.onreadystatechange=xhrCallbacks[id]=callback:callback()},abort:function(){callback&&callback(void 0,!0)}}}}),jQuery.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(text){return jQuery.globalEval(text),text}}}),jQuery.ajaxPrefilter("script",function(s){void 0===s.cache&&(s.cache=!1),s.crossDomain&&(s.type="GET",s.global=!1)}),jQuery.ajaxTransport("script",function(s){if(s.crossDomain){var script,head=document.head||jQuery("head")[0]||document.documentElement;return{send:function(_,callback){script=document.createElement("script"),script.async=!0,s.scriptCharset&&(script.charset=s.scriptCharset),script.src=s.url,script.onload=script.onreadystatechange=function(_,isAbort){(isAbort||!script.readyState||/loaded|complete/.test(script.readyState))&&(script.onload=script.onreadystatechange=null,script.parentNode&&script.parentNode.removeChild(script),script=null,isAbort||callback(200,"success"))},head.insertBefore(script,head.firstChild)},abort:function(){script&&script.onload(void 0,!0)}}}});var oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var callback=oldCallbacks.pop()||jQuery.expando+"_"+nonce++;return this[callback]=!0,callback}}),jQuery.ajaxPrefilter("json jsonp",function(s,originalSettings,jqXHR){var callbackName,overwritten,responseContainer,jsonProp=s.jsonp!==!1&&(rjsonp.test(s.url)?"url":"string"==typeof s.data&&!(s.contentType||"").indexOf("application/x-www-form-urlencoded")&&rjsonp.test(s.data)&&"data");return jsonProp||"jsonp"===s.dataTypes[0]?(callbackName=s.jsonpCallback=jQuery.isFunction(s.jsonpCallback)?s.jsonpCallback():s.jsonpCallback,jsonProp?s[jsonProp]=s[jsonProp].replace(rjsonp,"$1"+callbackName):s.jsonp!==!1&&(s.url+=(rquery.test(s.url)?"&":"?")+s.jsonp+"="+callbackName),s.converters["script json"]=function(){return responseContainer||jQuery.error(callbackName+" was not called"),responseContainer[0]},s.dataTypes[0]="json",overwritten=window[callbackName],window[callbackName]=function(){responseContainer=arguments},jqXHR.always(function(){window[callbackName]=overwritten,s[callbackName]&&(s.jsonpCallback=originalSettings.jsonpCallback,oldCallbacks.push(callbackName)),responseContainer&&jQuery.isFunction(overwritten)&&overwritten(responseContainer[0]),responseContainer=overwritten=void 0}),"script"):void 0}),jQuery.parseHTML=function(data,context,keepScripts){if(!data||"string"!=typeof data)return null;"boolean"==typeof context&&(keepScripts=context,context=!1),context=context||document;var parsed=rsingleTag.exec(data),scripts=!keepScripts&&[];return parsed?[context.createElement(parsed[1])]:(parsed=jQuery.buildFragment([data],context,scripts),scripts&&scripts.length&&jQuery(scripts).remove(),jQuery.merge([],parsed.childNodes))};var _load=jQuery.fn.load;jQuery.fn.load=function(url,params,callback){if("string"!=typeof url&&_load)return _load.apply(this,arguments);var selector,response,type,self=this,off=url.indexOf(" ");return off>=0&&(selector=jQuery.trim(url.slice(off,url.length)),url=url.slice(0,off)),jQuery.isFunction(params)?(callback=params,params=void 0):params&&"object"==typeof params&&(type="POST"),self.length>0&&jQuery.ajax({url:url,type:type,dataType:"html",data:params}).done(function(responseText){response=arguments,self.html(selector?jQuery("<div>").append(jQuery.parseHTML(responseText)).find(selector):responseText)}).complete(callback&&function(jqXHR,status){self.each(callback,response||[jqXHR.responseText,status,jqXHR])}),this},jQuery.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(i,type){jQuery.fn[type]=function(fn){return this.on(type,fn)}}),jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length};var docElem=window.document.documentElement;jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&jQuery.inArray("auto",[curCSSTop,curCSSLeft])>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,curOffset)),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,box={top:0,left:0},elem=this[0],doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(typeof elem.getBoundingClientRect!==strundefined&&(box=elem.getBoundingClientRect()),win=getWindow(doc),{top:box.top+(win.pageYOffset||docElem.scrollTop)-(docElem.clientTop||0),left:box.left+(win.pageXOffset||docElem.scrollLeft)-(docElem.clientLeft||0)}):box},position:function(){if(this[0]){var offsetParent,offset,parentOffset={top:0,left:0},elem=this[0];return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent||docElem;offsetParent&&!jQuery.nodeName(offsetParent,"html")&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||docElem})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top=/Y/.test(prop);jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?prop in win?win[prop]:win.document.documentElement[method]:elem[method]:void(win?win.scrollTo(top?jQuery(win).scrollLeft():val,top?val:jQuery(win).scrollTop()):elem[method]=val)},method,val,arguments.length,null)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery})},{}],2:[function(require,module,exports){module.exports=function(){"use strict";var app={};return app.init=function(modules){for(var i=0,length=modules.length;length>i;i++)modules[i].init()},app}()},{}],3:[function(require,module,exports){var lncd={};lncd.modules=lncd.modules||{},lncd.components=lncd.components||{},lncd.services=lncd.services||{},lncd.services.ResizeManager=function(){"use strict";var ResizeManager={};return ResizeManager.breaks={NARROW:320,NARROWER:480,MEDIUM:768,WIDE:1025,WIDEST:1440},ResizeManager.events={RESIZE:"resize",CHANGE:"change"},ResizeManager.matchSize=function(breakpoint){var mq=window.matchMedia("only screen and (min-width:"+breakpoint+"px)");return mq.matches},ResizeManager}(),lncd.services.ParallaxScrolling=function($,window){"use strict";var _self,ParallaxScrolling={},selectors={SCROLLING_ENABLED:".scrolling-enabled"},consts={SPEED:"speed",OFFSET:"offset"},events={SCROLL:"scroll"},$window=$(window);return ParallaxScrolling.init=function(onScrollCallbackFn){var $scrollBackgrounds=$(selectors.SCROLLING_ENABLED);_self=this,_self.onScrollActiveCallback=onScrollCallbackFn,_self.animateParallaxBackgrounds($scrollBackgrounds)},ParallaxScrolling.animateParallaxBackgrounds=function($backgrounds){$backgrounds.each(function(){var $bgElement=$(this);$window.on(events.SCROLL,function(){var speed=$bgElement.data(consts.SPEED),offset=$bgElement.data(consts.OFFSET)||0,yPosition=$window.scrollTop()/speed-offset,coords="50% "+yPosition+"px";$bgElement.css({backgroundPosition:coords}),_self.onScrollActiveCallback($bgElement)})})},ParallaxScrolling}(jQuery,window),lncd.modules.Navigation=function($,ResizeManager,ParallaxScrolling,window){"use strict";var currentView,currentIndex,scrollOfffset,_self,Navigation={},selectors={HTML:"html",BODY:"body",ANCHOR:"a",LIST:"li",MAIN_NAV:".main-nav",NAV_LINKS:".main-nav-links",SLIDE:".slide",SCROLL_ELEMENT:".scrolling-enabled"},events={CLICK:"click",POP_STATE:"popstate",LOAD:"load"},classes={SELECTED:"selected"},$window=$(window),$mainNav=$(selectors.MAIN_NAV),$navLinks=$(selectors.NAV_LINKS).find(selectors.ANCHOR),$slides=$(selectors.SLIDE),arr=[0],count=0;return Navigation.views=Navigation.views||{},Navigation.views.mobile=function(){var _self,view={},selectors={ICON_MENU:".icon-menu"},classes={EXPANDED:"expanded"},$navButton=$(selectors.ICON_MENU);return view.init=function(){_self=this,scrollOfffset=0,$navLinks.on(events.CLICK,_self.navigate),$navButton.on(events.CLICK,_self.toggleMenu)},view.clear=function(){scrollOfffset=null,$navLinks.off(events.CLICK,_self.navigate),$navButton.off(events.CLICK,_self.toggleMenu),$mainNav.removeClass(classes.EXPANDED)},view.toggleMenu=function(){$mainNav.toggleClass(classes.EXPANDED),$navButton.toggleClass(classes.EXPANDED)},view.navigate=function(evt){evt&&evt.preventDefault(),currentIndex=$(this).parent().index(),_self.toggleMenu(),_self.scrollTo(currentIndex,null,0)},view}(),Navigation.views.tablet=function(){var _self,view={},selectors={HOME_SLIDE:"#home"},classes={FIXED_TOP:"fixed-top"},$firstSlide=$(selectors.HOME_SLIDE);return view.init=function(){_self=this,scrollOfffset=$mainNav.height(),$navLinks.on(events.CLICK,_self.navigate)},view.clear=function(){scrollOfffset=null,$navLinks.off(events.CLICK,_self.navigate)},view.togglePosition=function($window){var firstElementHeight=$firstSlide.height()/2;return $window.scrollTop()>=firstElementHeight?void $mainNav.addClass(classes.FIXED_TOP):void $mainNav.removeClass(classes.FIXED_TOP)},view.navigate=function(evt){evt&&evt.preventDefault(),currentIndex=$(this).parent().index(),_self.scrollTo(currentIndex)},view}(),Navigation.init=function(){_self=this,_self.switchView(),_self.getView().togglePosition&&_self.getView().togglePosition($window),$window.on(events.LOAD,function(){_self.initRoute(),_self.scrollTo(currentIndex),_self.setSlideFocusTo(currentIndex)}),$window.on(ResizeManager.events.RESIZE,_self.switchView),$window.on(events.POP_STATE,function(){_self.scrollTo(event.state.page-1,0)}),ParallaxScrolling.init(_self.updateOnParallaxScroll)},Navigation.setView=function(type){currentView&&currentView.clear(),currentView=_self.views[type],currentView.scrollTo=_self.scrollTo,currentView.init()},Navigation.getView=function(){return currentView?currentView:void 0},Navigation.updateOnParallaxScroll=function($element){_self.getView().togglePosition&&_self.getView().togglePosition($window),_self.updateFocus($element)},Navigation.updateFocus=function($element){var slideClass=selectors.SLIDE.substr(1);if($element.hasClass(slideClass)){var slideOffset=100,scrollTop=$window.scrollTop(),slideIndex=$element.index(selectors.SLIDE),$slide=$element,slidePositionTop=$slide.position().top-slideOffset;scrollTop>=slidePositionTop&&scrollTop<slidePositionTop+$slide.height()&&(count++,arr[count]=slideIndex,arr[count]!==arr[count-1]&&(currentIndex=slideIndex,_self.setSlideFocusTo(currentIndex)))}},Navigation.switchView=function(){ResizeManager.matchSize(ResizeManager.breaks.MEDIUM)?Navigation.setView("tablet"):ResizeManager.matchSize(ResizeManager.breaks.NARROW)&&Navigation.setView("mobile")},Navigation.setSlideFocusTo=function(index){_self.selectLink(index),_self.setRoute(index)},Navigation.scrollTo=function(index,seconds,offset){var defaultSpeed=1.5,seconds=seconds||defaultSpeed,speed=1e3*seconds,offset=offset||scrollOfffset,$html=$(selectors.HTML+","+selectors.BODY),$element=$slides.eq(index);$html.animate({scrollTop:$element.offset().top-offset},speed)},Navigation.setRoute=function(index){var index=index||currentIndex,$slide=$slides.eq(index),location="#"+$slide.attr("id"),page=index+1,title=$navLinks.eq(index).text();window.history.pushState({page:page},title,location),window.location.hash=location},Navigation.initRoute=function(){var locationString=window.location.hash.substr(1),currentHash=locationString||$slides.eq(0).attr("id");$slides.each(function(currentSlideIndex){var $slide=$(this),slideID=$slide.attr("id");slideID===currentHash&&(currentIndex=currentSlideIndex)})},Navigation.selectLink=function(index){var $link=$navLinks.eq(index)||$navLinks.eq(0);$navLinks.removeClass(classes.SELECTED),$link.addClass(classes.SELECTED)},Navigation}(jQuery,lncd.services.ResizeManager,lncd.services.ParallaxScrolling,window),lncd.modules.Gallery=function($){"use strict";var _self,Gallery={},selectors={THUMB_BUTTON_INFO:".thumb-button-info",THUMB_BUTTON_CLOSE:".thumb-button-close",GALLERY_THUMB_OVERLAY:".gallery-thumb-overlay",GALLERY_THUMB:".gallery-thumb"},events={CLICK:"click"},classes={VISIBLE:"visible"},$galleryThumbnailOverlay=$(selectors.GALLERY_THUMB_OVERLAY);return Gallery.init=function(){var $thumbnailInfoButton=$(selectors.THUMB_BUTTON_INFO),$thumbnailCloseInfoButton=$(selectors.THUMB_BUTTON_CLOSE);_self=this,$thumbnailInfoButton.on(events.CLICK,_self.toggleThumbInfoOverlay),$thumbnailCloseInfoButton.on(events.CLICK,_self.toggleThumbInfoOverlay)},Gallery.toggleThumbInfoOverlay=function(evt){evt.preventDefault();var $target=$(this),index=$target.closest(selectors.GALLERY_THUMB).index();$galleryThumbnailOverlay.eq(index).toggleClass(classes.VISIBLE)},Gallery}(jQuery),lncd.modules.ContactForm=function($){"use strict";var _self,ContactForm={},selectors={SUBMIT_BUTTON:"#contact-form-submit",USER_NAME:"#name",USER_PHONE:"#phone",USER_EMAIL:"#email",USER_SUBJECT:"#subject",USER_MESSAGE:"#message"},events={CLICK:"click"};return ContactForm.init=function(){var $submitButton=$(selectors.SUBMIT_BUTTON);_self=this,$submitButton.on(events.CLICK,_self.submit)},ContactForm.submit=function(evt){evt.preventDefault();var userName=$(selectors.USER_NAME).val(),userPhone=$(selectors.USER_PHONE).val(),userEail=$(selectors.USER_EMAIL).val(),userSubject=$(selectors.USER_SUBJECT).val(),userMessage=$(selectors.USER_MESSAGE).val(),userContactDetails={name:userName,phone:userPhone,email:userEail,subject:userSubject,message:userMessage},jqxhr=$.ajax({url:"/sendquestion",type:"POST",data:userContactDetails});jqxhr.done(_self.submitSuccessHandler),jqxhr.fail(_self.submitFailureHandler)},ContactForm.submitSuccessHandler=function(data){alert("Message have been sent")},ContactForm.submitFailureHandler=function(data){alert("Message could not be sent")},ContactForm}(jQuery),lncd.app=function(Navigation,Gallery,ContactForm){"use strict";var app={};return app.init=function(){Navigation.init(),ContactForm.init(),Gallery.init()},app.init(),app}(lncd.modules.Navigation,lncd.modules.Gallery,lncd.modules.ContactForm)},{}],4:[function(require,module,exports){var app=require("./app.js"),ContactForm=(require("./services/parallaxscrolling.js"),require("./services/resizemanager.js"),require("./modules/navigation.js")),Gallery=require("./modules/gallery.js"),Navigation=require("./modules/contactform.js");app.init([ContactForm,Gallery,Navigation])},{"./app.js":2,"./modules/contactform.js":5,"./modules/gallery.js":6,"./modules/navigation.js":7,"./services/parallaxscrolling.js":9,"./services/resizemanager.js":10}],5:[function(require,module,exports){var $=require("jquery");module.exports=function(){"use strict";var _self,ContactForm={},selectors={SUBMIT_BUTTON:"#contact-form-submit",USER_NAME:"#name",USER_PHONE:"#phone",USER_EMAIL:"#email",USER_SUBJECT:"#subject",USER_MESSAGE:"#message"},events={CLICK:"click"};return ContactForm.init=function(){var $submitButton=$(selectors.SUBMIT_BUTTON);_self=this,$submitButton.on(events.CLICK,_self.submit)},ContactForm.submit=function(evt){evt.preventDefault();var userName=$(selectors.USER_NAME).val(),userPhone=$(selectors.USER_PHONE).val(),userEail=$(selectors.USER_EMAIL).val(),userSubject=$(selectors.USER_SUBJECT).val(),userMessage=$(selectors.USER_MESSAGE).val(),userContactDetails={name:userName,phone:userPhone,email:userEail,subject:userSubject,message:userMessage},jqxhr=$.ajax({url:"/sendquestion",type:"POST",data:userContactDetails});jqxhr.done(_self.submitSuccessHandler),jqxhr.fail(_self.submitFailureHandler)},ContactForm.submitSuccessHandler=function(data){alert("Message have been sent")},ContactForm.submitFailureHandler=function(data){alert("Message could not be sent")},ContactForm}()},{jquery:1}],6:[function(require,module,exports){var $=require("jquery");module.exports=function(){"use strict";var _self,Gallery={},selectors={THUMB_BUTTON_INFO:".thumb-button-info",THUMB_BUTTON_CLOSE:".thumb-button-close",GALLERY_THUMB_OVERLAY:".gallery-thumb-overlay",GALLERY_THUMB:".gallery-thumb"},events={CLICK:"click"},classes={VISIBLE:"visible"},$galleryThumbnailOverlay=$(selectors.GALLERY_THUMB_OVERLAY);return Gallery.init=function(){var $thumbnailInfoButton=$(selectors.THUMB_BUTTON_INFO),$thumbnailCloseInfoButton=$(selectors.THUMB_BUTTON_CLOSE);_self=this,$thumbnailInfoButton.on(events.CLICK,_self.toggleThumbInfoOverlay),$thumbnailCloseInfoButton.on(events.CLICK,_self.toggleThumbInfoOverlay)},Gallery.toggleThumbInfoOverlay=function(evt){evt.preventDefault();var $target=$(this),$currentOverlay=$galleryThumbnailOverlay.eq(index);return index=$target.closest(selectors.GALLERY_THUMB).index(),$currentOverlay.hasClass(!classes.VISIBLE)?void classes.VISIBLE.addClass(classes.VISIBLE):void $currentOverlay.toggleClass(classes.VISIBLE)},Gallery}()},{jquery:1}],7:[function(require,module,exports){var $=require("jquery"),ResizeManager=require("../services/resizemanager.js"),ParallaxScrolling=require("../services/parallaxscrolling.js");module.exports=function(){"use strict";var currentView,currentIndex,scrollOfffset,_self,Navigation={},selectors={HTML:"html",BODY:"body",ANCHOR:"a",LIST:"li",MAIN_NAV:".main-nav",NAV_LINKS:".main-nav-links",SLIDE:".slide",SCROLL_ELEMENT:".scrolling-enabled"},events={CLICK:"click",POP_STATE:"popstate",LOAD:"load"},classes={SELECTED:"selected"},$window=$(window),$mainNav=$(selectors.MAIN_NAV),$navLinks=$(selectors.NAV_LINKS).find(selectors.ANCHOR),$slides=$(selectors.SLIDE),arr=[0],count=0;return Navigation.views=Navigation.views||{},Navigation.views.mobile=function(){var _self,view={},selectors={ICON_MENU:".icon-menu"},classes={EXPANDED:"expanded"},$navButton=$(selectors.ICON_MENU);return view.init=function(){_self=this,scrollOfffset=0,$navLinks.on(events.CLICK,_self.navigate),$navButton.on(events.CLICK,_self.toggleMenu)},view.clear=function(){scrollOfffset=null,$navLinks.off(events.CLICK,_self.navigate),$navButton.off(events.CLICK,_self.toggleMenu),$mainNav.removeClass(classes.EXPANDED)},view.toggleMenu=function(){$mainNav.toggleClass(classes.EXPANDED),$navButton.toggleClass(classes.EXPANDED)},view.navigate=function(evt){evt&&evt.preventDefault(),currentIndex=$(this).parent().index(),_self.toggleMenu(),_self.scrollTo(currentIndex,null,0)},view}(),Navigation.views.tablet=function(){var _self,view={},selectors={HOME_SLIDE:"#home"},classes={FIXED_TOP:"fixed-top"},$firstSlide=$(selectors.HOME_SLIDE);return view.init=function(){_self=this,scrollOfffset=$mainNav.height(),$navLinks.on(events.CLICK,_self.navigate)},view.clear=function(){scrollOfffset=null,$navLinks.off(events.CLICK,_self.navigate)},view.togglePosition=function($window){var firstElementHeight=$firstSlide.height()/2;return $window.scrollTop()>=firstElementHeight?void $mainNav.addClass(classes.FIXED_TOP):void $mainNav.removeClass(classes.FIXED_TOP)},view.navigate=function(evt){evt&&evt.preventDefault(),currentIndex=$(this).parent().index(),_self.scrollTo(currentIndex)},view}(),Navigation.init=function(){_self=this,_self.switchView(),_self.getView().togglePosition&&_self.getView().togglePosition($window),$window.on(events.LOAD,function(){_self.initRoute(),_self.scrollTo(currentIndex),_self.setSlideFocusTo(currentIndex)}),$window.on(ResizeManager.events.RESIZE,_self.switchView),$window.on(events.POP_STATE,function(){_self.scrollTo(event.state.page-1,0)}),ParallaxScrolling.init(_self.updateOnParallaxScroll)},Navigation.setView=function(type){currentView&&currentView.clear(),currentView=_self.views[type],currentView.scrollTo=_self.scrollTo,currentView.init()},Navigation.getView=function(){return currentView?currentView:void 0},Navigation.updateOnParallaxScroll=function($element){_self.getView().togglePosition&&_self.getView().togglePosition($window),_self.updateFocus($element)},Navigation.updateFocus=function($element){var slideClass=selectors.SLIDE.substr(1);if($element.hasClass(slideClass)){var slideOffset=100,scrollTop=$window.scrollTop(),slideIndex=$element.index(selectors.SLIDE),$slide=$element,slidePositionTop=$slide.position().top-slideOffset;scrollTop>=slidePositionTop&&scrollTop<slidePositionTop+$slide.height()&&(count++,arr[count]=slideIndex,arr[count]!==arr[count-1]&&(currentIndex=slideIndex,_self.setSlideFocusTo(currentIndex)))}},Navigation.switchView=function(){ResizeManager.matchSize(ResizeManager.breaks.MEDIUM)?Navigation.setView("tablet"):ResizeManager.matchSize(ResizeManager.breaks.NARROW)&&Navigation.setView("mobile")},Navigation.setSlideFocusTo=function(index){_self.selectLink(index),_self.setRoute(index)},Navigation.scrollTo=function(index,seconds,offset){var defaultSpeed=1.5,seconds=seconds||defaultSpeed,speed=1e3*seconds,offset=offset||scrollOfffset,$html=$(selectors.HTML+","+selectors.BODY),$element=$slides.eq(index);$html.animate({scrollTop:$element.offset().top-offset},speed)},Navigation.setRoute=function(index){var index=index||currentIndex,$slide=$slides.eq(index),location="#"+$slide.attr("id"),page=index+1,title=$navLinks.eq(index).text();window.history.pushState({page:page},title,location),window.location.hash=location},Navigation.initRoute=function(){var locationString=window.location.hash.substr(1),currentHash=locationString||$slides.eq(0).attr("id");$slides.each(function(currentSlideIndex){var $slide=$(this),slideID=$slide.attr("id");slideID===currentHash&&(currentIndex=currentSlideIndex)})},Navigation.selectLink=function(index){var $link=$navLinks.eq(index)||$navLinks.eq(0);$navLinks.removeClass(classes.SELECTED),$link.addClass(classes.SELECTED)},Navigation}()},{"../services/parallaxscrolling.js":9,"../services/resizemanager.js":10,jquery:1}],8:[function(require,module,exports){!function(){for(var method,noop=function(){},methods=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],length=methods.length,console=window.console=window.console||{};length--;)method=methods[length],console[method]||(console[method]=noop)}()},{}],9:[function(require,module,exports){var $=require("jquery");module.exports=function(){"use strict";var _self,ParallaxScrolling={},selectors={SCROLLING_ENABLED:".scrolling-enabled"},consts={SPEED:"speed",OFFSET:"offset"
},events={SCROLL:"scroll"},$window=$(window);return ParallaxScrolling.init=function(onScrollCallbackFn){var $scrollBackgrounds=$(selectors.SCROLLING_ENABLED);_self=this,_self.onScrollActiveCallback=onScrollCallbackFn,_self.animateParallaxBackgrounds($scrollBackgrounds)},ParallaxScrolling.animateParallaxBackgrounds=function($backgrounds){$backgrounds.each(function(){var $bgElement=$(this);$window.on(events.SCROLL,function(){var speed=$bgElement.data(consts.SPEED),offset=$bgElement.data(consts.OFFSET)||0,yPosition=$window.scrollTop()/speed-offset,coords="50% "+yPosition+"px";$bgElement.css({backgroundPosition:coords}),_self.onScrollActiveCallback($bgElement)})})},ParallaxScrolling}()},{jquery:1}],10:[function(require,module,exports){module.exports=function(){"use strict";var ResizeManager={};return ResizeManager.breaks={NARROW:320,NARROWER:480,MEDIUM:768,WIDE:1025,WIDEST:1440},ResizeManager.events={RESIZE:"resize",CHANGE:"change"},ResizeManager.matchSize=function(breakpoint){var mq=window.matchMedia("only screen and (min-width:"+breakpoint+"px)");return mq.matches},ResizeManager}()},{}]},{},[2,3,4,5,6,7,8,9,10]);
